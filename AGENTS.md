...
**Last Updated**: July 2026 (Updated `chihiro` configuration to support optional `external-dns` and `gateway-api` parameters via ConfigMap toggles. Updated `AGENTS.md` to reflect these changes.)
